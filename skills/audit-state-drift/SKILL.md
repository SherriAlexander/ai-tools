---
name: audit-state-drift
description: Run parallel tasks to detect and fix state synchronization issues, impossible states, and state management anti-patterns.
context: fork
---
